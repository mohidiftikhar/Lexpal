<x-app-layout>
    ...
    <div class="form">
        ...
        <form action="{!! route('plans.store') !!}" method="post" id="form" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" step="any" class="form-control" name="price" id="price" placeholder="Enter price" value="{{old('price')}}"><br>
            </div>
            <div class="form-group">
                <label for="currency">Plan Currency</label>
                <input type="text" class="form-control" name="currency" id="currency" placeholder="Enter currency" value="{{old('currency')}}"><br>
            </div>
            <div class="form-group">
                <label for="plan_duration">Plan Duration</label>
                <input type="text" class="form-control" name="plan_duration" id="plan_duration" placeholder="Enter duration" value="{{old('plan_duration')}}"><br>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="content" placeholder="Enter plan content" id="editor">{{old('content')}}</textarea>
            </div>
            <br>
            <div class="mb-3">
