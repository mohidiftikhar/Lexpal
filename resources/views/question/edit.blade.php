<x-app-layout>
    ...
    <div class="form">
        ...
        <form action="{!! route('question.update',$question->id) !!}" method="post" enctype="multipart/form-data" id="form">
            @csrf
            <div class="form-group">
                <label for="question">Question</label>
                <textarea name="question" placeholder="Question" id="QuestionEditor">{{$question->question}}</textarea>
            </div>
            <div class="form-group">
                <label for="answer">Answer</label>
                <textarea name="answer" placeholder="Answer" id="editor">{{$question->answer}}</textarea>
            </div>
            <br>
